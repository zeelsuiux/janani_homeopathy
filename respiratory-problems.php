...
<section class="treatment-hero">
    <div class="container treatment-hero-grid">
        ...
        <div class="treatment-visual">
            <img src="assets/images/treatments/respiratory-problems.png" onerror="this.src='assets/images/doctor.png'" alt="Respiratory care">
...
<?php foreach ($conditions as $conditiosnIndex => $condition): ?><div class="feature-card"><div class="icon treatment-icon"><?= treatment_icon($condition[0], $conditionIndex) ?></div><h3><?= e($condition[0]) ?></h3><p><?= e($condition[1]) ?></p></div><?php endforeach; ?>
</div></div></section>
