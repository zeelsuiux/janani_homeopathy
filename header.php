...
<body>
    <header class="nav">
        <div class="container nav-inner"><a href="index.php"><img class="logo" src="assets/images/logo.png" alt="<?= e($s['clinic_name']) ?>"></a><button class="mobile-toggle">☰</button>
            <nav class="menu"><a href="index.php">Home</a><a href="about.php">About</a><a href="mental-diseases.php">Mental Diseases</a><a href="treatments.php">Treatments</a><a href="gallery.php">Gallery</a><a href="blog.php">Blog</a><a href="contact.php">Contact</a><a class="btn" href="appointment.php">Book Appointment</a></nav>
        </div>
    </header>