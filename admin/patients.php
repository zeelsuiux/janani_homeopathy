...
<tr><th>Patient No</th><th>Name</th><th>DOB</th><th>Age</th><th>Mobile</th><th>Created Date</th><th>Total Paid</th><th>Appointments</th><th>Actions</th></tr>
...
<tr class="patient-row" data-search="<?=e(strtolower($p['number'].' '.$p['name'].' '.$p['mobile']))?>">
    <td><?=e($p['number'])?></td><td><?=e($p['name'])?></td><td><?=e(date_fmt($p['dob']))?></td><td><?=e($p['age'])?></td><td><?=e($p['mobile'])?></td><td><?=e(date_fmt($p['created_at'] ?? ''))?></td><td>₹<?=number_format($paid,2)?></td><td><?=count($aps)?></td>
...
<?php endforeach; ?>
<tr id="noPatientsFound" style="display:none"><td colspan="9" style="text-align:center;padding:30px">No patients found.</td></tr>
</table>
</div>
<script>
(function(){
