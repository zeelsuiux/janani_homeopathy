<?php require 'header.php'; $db=db_load(); $page_title='Patients'; $patients=$db['patients']; ?>
<div class="admin-top patients-toolbar">
    ...
    <div class="patients-actions">
        ...
        <a class="btn" href="patient-form.php">+ New Patient</a>
    </div>
</div>
...
<tr class="patient-row" data-search="<?=e(strtolower($p['number'].' '.$p['name'].' '.$p['mobile']))?>">
    ...
    <td><div class="actions"><a class="btn btn-sm" href="patient-view.php?id=<?=e($p['id'])?>">View</a><a class="btn btn-sm btn-outline" href="patient-form.php?id=<?=e($p['id'])?>">Edit</a><a class="btn btn-sm btn-danger" href="patient-delete.php?id=<?=e($p['id'])?>" onclick="return confirm('Delete patient and appointments?')">Delete</a></div></td>
</tr>
<?php endforeach; ?>
